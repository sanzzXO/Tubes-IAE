...
echo - Auth Service: http://localhost:8000/test-integration
echo - Book Catalog Service: http://localhost:8001/test-integration
echo - Borrowing Service: http://localhost:8002/test-integration
echo - Review Service: http://localhost:8003/test-integration
echo.
